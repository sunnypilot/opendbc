...
class MadsCarController:
  ...
  def create_lkas_icon(self, CP: structs.CarParams, enabled: bool) -> int:
    ...
    # Override common signals for KIA_OPTIMA_G4, KIA_OPTIMA_G4_FL, HYUNDAI_KONA_NON_SCC, and KIA_OPTIMA_G4_FL_NON_SCC
    if CP.carFingerprint in (CAR.KIA_OPTIMA_G4, CAR.KIA_OPTIMA_G4_FL, CAR.HYUNDAI_KONA_NON_SCC, CAR.KIA_OPTIMA_G4_FL_NON_SCC):
