...
from opendbc.sunnypilot.car.hyundai.values import RADAR_ADDRESS, ADAS_ECU_ADDRESS
...
def _disable_ecus(CP: structs.CarParams, can_recv: CanRecvCallable = None, can_send: CanSendCallable = None) -> None:
  if CP.brand != 'hyundai':
    return 
