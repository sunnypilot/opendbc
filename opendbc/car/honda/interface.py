      ...
      if eps_modified:
        for fw in car_fw:
          if fw.ecu == "eps" and b"-" not in fw.fwVersion and b"," in fw.fwVersion:
            ...
            stock_cp.lateralParams.torqueBP, stock_cp.lateralParams.torqueV = [[0, 0xA00, 0x3C00], [0, 2560, 3840]]
            ...
            stock_cp.lateralParams.torqueBP, stock_cp.lateralParams.torqueV = [[0, 0xA00, 0x2800], [0, 2560, 3840]]
