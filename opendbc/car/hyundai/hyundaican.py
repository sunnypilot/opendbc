...
def create_lkas11(packer, frame, CP, apply_torque, steer_req,
  ...
  if CP.carFingerprint in (CAR.HYUNDAI_SONATA, CAR.HYUNDAI_PALISADE, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_PLUS_EV, CAR.KIA_NIRO_HEV_2021, CAR.KIA_NIRO_PHEV_2022, CAR.KIA_NIRO_PLUS_EV, CAR.HYUNDAI_SANTA_FE,
