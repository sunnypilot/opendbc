...
from opendbc.sunnypilot.car.hyundai.hyundaican import create_acc_commands_escc
...
def create_acc_commands(packer, enabled, accel, upper_jerk, idx, hud_control, set_speed, stopping, long_override, use_fca,
  ...
  if ESCC and ESCC.enabled:
    return create_acc_commands_escc(packer, enabled, accel, upper_jerk, idx, hud_control, set_speed, stopping, long_override, use_fca,
                                    ESCC)
