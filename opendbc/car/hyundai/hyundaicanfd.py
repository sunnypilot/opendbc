...
def create_hda2_cluster(packer, CAN, lfa_icon, left_blinker, right_blinker, hud_control, hyundaicanfd_ext, out):
  ...
  values = {
    ...
    "HDA_LtLineLatPos": hyundaicanfd_ext.lanelineLeft,
    "HDA_RtLineLatPos": hyundaicanfd_ext.lanelineRight,
