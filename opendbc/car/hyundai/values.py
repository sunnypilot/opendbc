...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    if CP.flags & HyundaiFlags.CANFD:
      self.STEER_MAX = 384 if CP.flags & HyundaiFlags.CANFD_LFA_CAMERA_SYNC else 270
      self.STEER_DRIVER_ALLOWANCE = 250
      self.STEER_DRIVER_MULTIPLIER = 2
      self.STEER_THRESHOLD = 250
      self.STEER_DELTA_UP = 4 if CP.flags & HyundaiFlags.CANFD_LFA_CAMERA_SYNC else 2
      self.STEER_DELTA_DOWN = 7 if CP.flags & HyundaiFlags.CANFD_LFA_CAMERA_SYNC else 3
