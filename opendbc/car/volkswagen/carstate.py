  ...
  def update(self, can_parsers) -> tuple[structs.CarState, structs.CarStateSP]:
    ...
    if self.CP.flags & VolkswagenFlags.MEB:
      ...
      if self.CP.enableBsm:
        ret.leftBlindspot = bool(ext_cp.vl["MEB_Side_Assist_01"]["Blind_Spot_Info_Left"]) or bool(
          ext_cp.vl["MEB_Side_Assist_01"]["Blind_Spot_Warn_Left"])
        ret.rightBlindspot = bool(ext_cp.vl["MEB_Side_Assist_01"]["Blind_Spot_Info_Right"]) or bool(
          ext_cp.vl["MEB_Side_Assist_01"]["Blind_Spot_Warn_Right"])
      ...
      ret.cruiseState.speed = int(
        round(ext_cp.vl["MEB_ACC_01"]["ACC_Wunschgeschw_02"])) * CV.KPH_TO_MS if self.CP.pcmCruise else 0
