...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    if ret.flags & ToyotaFlags.RADAR_ACC or candidate in NO_DSU_CAR:
      ret.alphaLongitudinalAvailable = ret.flags & ToyotaFlags.RADAR_ACC or candidate in RADAR_ACC_CAR
