...
def create_accel_command(packer, accel, pcm_cancel, permit_braking, standstill_req, lead, acc_type, fcw_alert, distance, SECOC_LONG: SecOCLong = None, flip_acc_increments = False):
  ...
  values = {
    ...
    "ALLOW_LONG_PRESS": 2 if flip_acc_increments else 1,
