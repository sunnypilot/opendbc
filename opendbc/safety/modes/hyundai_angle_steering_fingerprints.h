...
#define HYUNDAI_BASELINE_STEERING_PARAMS HYUNDAI_SANTA_FE_HEV_5TH_GEN_STEERING_PARAMS

#define HYUNDAI_ECU_FINGERPINTS_M(addr, ver, params) \
  {addr, ver, params}

static const hyundai_angle_fingerprint_t HYUNDAI_ECU_RESPONSE_FINGERPRINTS[] = {
  HYUNDAI_ECU_FINGERPINTS_M(HYUDAI_CAM_UDS_ADDR, "NE  MFC  AT USA LHD 1.00 1.01 99211-PI000 240905", &HYUNDAI_IONIQ_5_PE_STEERING_PARAMS),
  HYUNDAI_ECU_FINGERPINTS_M(HYUDAI_CAM_UDS_ADDR, "NE  MFC  AT EUR LHD 1.00 1.03 99211-GI500 240809", &HYUNDAI_IONIQ_5_PE_STEERING_PARAMS),
  HYUNDAI_ECU_FINGERPINTS_M(HYUDAI_CAM_UDS_ADDR, "JX  MFC  AT USA LHD 1.00 1.03 99211-T6510 240124", &GENESIS_GV80_2025_STEERING_PARAMS),
};
