...
# LKA steering + ALT_BUTTONS (e.g. 2026 Kia Carnival Hybrid). Required because the
# LKA init paths previously hardcoded STD_BUTTONS, which caused safetyRxChecksInvalid.
...
# LKA steering + ALT_BUTTONS + sunnypilot longitudinal
